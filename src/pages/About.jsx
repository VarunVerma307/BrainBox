...
const About = () => {
  return (
    <div>
      ...
      <section className="border-b border-richblack-900">
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white">
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            <div className="my-24 flex lg:w-[50%] flex-col gap-10">
              <h1 className="text-yellow-50 bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] ">
                Our Founding Story
              </h1>
              <p className="text-base font-medium text-white lg:w-[95%] text-justify">

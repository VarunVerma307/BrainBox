  ...
  return (
    <div>
        ...
        <div className='lg:w-[40%]'>
            <div className='flex items-center justify-center p-2 mb-5'>  <img src={image}/></div>
            ...
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-900 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <h1 className="text-lg font-semibold text-yellow-50">Chat on us</h1>
                    </div>
                    <p className='font-medium'>Our friendly team is here to help.</p>
                    <p className='font-semibold'>info@BrainBox.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <h1 className="text-lg font-semibold text-yellow-50">Visit us</h1>
                    </div>
                ...
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    ...
                    <h1 className="text-lg font-semibold text-yellow-50">Call us</h1>
                </div>
